...
divStyle = style [("background-image", "url(CV_Photos/b.jpg)")
                  ,("border-style","solid")
...
main = div [divStyle] [
              ...
              ,img [src "CV_Photos/connor123.jpg",style [("width","100%")]] []

              ,aside [skillsStyle] [
                          text "Skills:"
                          ,ul [] [
                                li [] [text "Using Python"]
                                ,img [src "CV_Photos/4_stars.png",style [("width","100%")]] []
                                ,li [] [text "Using Swift"]
                                ,img [src "CV_Photos/3.5_stars.png",style [("width","100%")]] []
              ...
              ,section [mainStyle] [
                                    ...
                                    , ul [] [
                                            ...
                                            ,li [] [text "Link to back to other CV page " ,a [href "index.html"] [text "Here"]]
